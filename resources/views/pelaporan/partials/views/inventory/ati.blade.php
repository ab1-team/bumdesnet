...
<table border="0" width="100%">
    <thead>
        <tr style="background: rgb(74, 74, 74); font-weight: bold; text-align: center; color: #fff;">
            ...
            <th class="t l b" rowspan="2" width="9%">Harga Satuan</th>
    ...
    <tbody>
        ...
        <tr>
            <td class="t l b" colspan="5" height="15">
            ...
            <td class="t l b">&nbsp;</td>
            <td class="t l b">&nbsp;</td>
            <td class="t l b" align="center">{{ $j_penyusutan == 0 ? '0' : '' }}</td>
            <td class="t l b" align="right">{{ number_format($j_penyusutan, 2) }}</td>
            <td class="t l b" align="center">{{ $j_akum_susut == 0 ? '0' : '' }}</td>
            <td class="t l b" align="right">{{ number_format($j_akum_susut, 2) }}</td>
            <td class="t l b r" align="right">{{ number_format($j_nilai_buku, 2) }}</td>
        </tr>

        <tr>
            <td class="t l b" colspan="5" height="15"><b>Jumlah</b></td>
            <td class="t l b" align="center">{{ number_format($t_unit, 2) }}</td>
            <td class="t l b">&nbsp;</td>
            <td class="t l b" align="right">{{ number_format($t_harga, 2) }}</td>
            <td class="t l b">&nbsp;</td>
            <td class="t l b">&nbsp;</td>
            <td class="t l b" align="center">&nbsp;</td>
            <td class="t l b" align="right">{{ number_format($t_penyusutan, 2) }}</td>
            <td class="t l b" align="center">&nbsp;</td>
            <td class="t l b" align="right">{{ number_format($t_akum_susut, 2) }}</td>
            <td class="t l b r" align="right">{{ number_format($t_nilai_buku, 2) }}</td>
        </tr>
    </tbody>
</table>