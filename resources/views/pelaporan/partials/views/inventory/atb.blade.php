...
<table border="0" width="100%">
    ...
    <tbody>
        ...
        <tr>
            <td class="t l b r" colspan="15" style="padding: 0px !important">
                <table class="p" border="0" width="100%" cellspacing="0" cellpadding="0"
                    style="font-size: 11px; table-layout: fixed;">
                    <tr>
                        <td class="t l b" class="t l b" width="40%" height="15">
                            Jumlah
                        </td>
                        <td class="t l b" class="t l b" width="3%" align="center">
                            {{ number_format($t_unit, 2) }}</td>
                        <td class="t l b" class="t l b" width="9%">&nbsp;</td>
                        <td class="t l b" class="t l b" width="9%" align="right">
                            {{ number_format($t_harga, 2) }}</td>
                        <td class="t l b" class="t l b" width="4%">&nbsp;</td>
                        <td class="t l b" class="t l b" width="8%">&nbsp;</td>
                        <td class="t l b" class="t l b" width="12%" align="right">
                            {{ number_format($t_penyusutan, 2) }}
                        </td>
                        <td class="t l b" class="t l b" width="12%" align="right">
                            {{ number_format($t_akum_susut, 2) }}
                        </td>
                        <td class="t l b r" class="t l b r" width="8%" align="right">
